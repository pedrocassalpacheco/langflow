...
from langflow.base.vectorstores.graph_rag_mixin import GraphRAGSupportedMixin
...
class AstraDBVectorStoreComponent(LCVectorStoreComponent):  # , GraphRAGSupportedMixin):
    ...
    # GraphRAGSupportedMixin.add_output()
